    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0d1117] border-b border-white/5">
      <div className="max-w-[1280px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <a
            href="#"
            className="px-5 py-2 rounded-full border border-white/20 text-white text-[14px] no-underline hover:border-white/40 transition-colors"
          >
            Get the app
          </a>
          ...
          <a
            href="#"
            className="px-5 py-2 rounded-full bg-blue-600 hover:bg-blue-500 text-white text-[14px] font-semibold no-underline transition-colors"
          >
            For Artists
          </a>
